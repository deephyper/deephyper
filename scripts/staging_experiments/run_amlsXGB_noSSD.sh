...
WALLMINUTES=60   # should be about 10 min less than COBALT requested time
MAXEVALS=100000000
STAGE_IN_DIR=""
...
JOBNAME="$BNAME"_"$NNODES"_"$METHOD"_"noSSD"
WORKFLOWNAME="$BNAME"_"$NNODES"_"$METHOD"_"noSSD"
