...
from deephyper.benchmark.nas.toy.pb_keras_class import Problem
from deephyper.search import util
from deephyper.search.nas.model.keras.trainers.classifier_train_valid import \
...
model = structure.create_model(train=True, activation='softmax')
