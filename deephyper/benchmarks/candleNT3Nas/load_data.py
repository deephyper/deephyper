...
def load_data(dest = None):
    ...
    gParameters = {'shuffle': True, 'verbose': False, 'conv': [128, 20, 1, 128, 10, 1], 'run_id': 'RUN.000',
                       'epochs': 400, 'alpha_dropout': False, 'out_act': 'softmax', 'logfile': None,
                       'dense': [200, 20], 'save': '.', 'activation': 'relu',
                       'data_url': 'ftp://ftp.mcs.anl.gov/pub/candle/public/benchmarks/Pilot1/normal-tumor/',
                       'optimizer': 'sgd', 'timeout': -1, 'learning_rate': 0.001, 'batch_size': 20,
                       'metrics': 'accuracy', 'gpus': [], 'train_bool': True, 'pool': [1, 10],
                       'loss': 'categorical_crossentropy', 'datatype': 'numpy.float32', 'drop': 0.1,
                       'config_file': '/Users/dipendra/Projects/Benchmarks/Pilot1/NT3/nt3_default_model.txt',
                       'test_data': 'nt_test2.csv', 'classes': 2, 'experiment_id': 'EXP.000', 'model_name': 'nt3',
