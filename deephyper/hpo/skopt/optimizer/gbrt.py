...
def gbrt_minimize(
    ...
    func : callable
        ...
        then you can use `deephyper.hpo.skopt.utils.use_named_args` as a decorator
    ...
    .. seealso:: functions :class:`deephyper.hpo.skopt.gp_minimize`,
        :class:`deephyper.hpo.skopt.dummy_minimize`, :class:`deephyper.hpo.skopt.forest_minimize`
    """
    # Check params
