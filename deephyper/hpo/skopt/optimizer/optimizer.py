...
class Optimizer(object):
    ...
    Attributes:
        ...
        models (list):
            ...
            function.
        space (Space):
            An instance of `deephyper.hpo.skopt.space.Space`. Stores parameter search
        ...
        if fit and self._n_initial_points <= 0 and self.base_estimator_ is not None:
            ...
            for cand_acq_func in self.cand_acq_funcs_:
                ...
                # points and the best minimum is used
                    ...
                    from deephyper.hpo.skopt.optimizer._pymoo import (
                    ...
                    from deephyper.hpo.skopt.optimizer._pymoo import PyMOORealProblem
