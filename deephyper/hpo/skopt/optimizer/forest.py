...
def forest_minimize(
    ...
    func : callable
        ...
        with the named arguments. See :func:`deephyper.hpo.skopt.utils.use_named_args`
        for an example.
    ...
    .. seealso:: functions :class:`deephyper.hpo.skopt.gp_minimize`,
        :class:`deephyper.hpo.skopt.dummy_minimize`, :class:`deephyper.hpo.skopt.gbrt_minimize`
    """
