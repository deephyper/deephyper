...
:mod:`deephyper.hpo.skopt.moo`, which may be of external interest.
...
2. additional documentation -- because certain optimization-related features
    (such as multiobjective features in :mod:`deephyper.hpo.skopt.moo`)
...
In general, the :class:`deephyper.hpo.skopt.optimizer.optimizer.Optimizer` class defines the basic functionality, which
is used by the functions in :mod:`deephyper.hpo.skopt.optimizer`.
...
is called.
Other notable modules include :mod:`deephyper.hpo.skopt.acquisition` and
:mod:`deephyper.hpo.skopt.sampler`, selected by similar str arguments in
...
:mod:`deephyper.hpo.skopt.moo` module, and used by the :class:`deephyper.hpo.skopt.optimizer.optimizer.Optimizer`.
"""
