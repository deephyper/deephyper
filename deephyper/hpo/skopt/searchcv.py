...
class BayesSearchCV(BaseSearchCV):
    ...
    Parameters are presented as a list of deephyper.hpo.skopt.space.Dimension objects.
    ...
    search_spaces : dict, list of dict or list of tuple containing (dict, int).
        ...
        and values are deephyper.hpo.skopt.space.Dimension instances (Real, Integer
        or Categorical) or any other valid value that defines skopt
        dimension (see deephyper.hpo.skopt.Optimizer docs). Represents search space
    ...
    def _make_optimizer(self, params_space):
        ...
        params_space : dict
            ...
            names (strings) and values are deephyper.hpo.skopt.space.Dimension instances,
