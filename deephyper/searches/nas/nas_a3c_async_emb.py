...
from deephyper.searches.nas.agent import nas_ppo_async_a3c_emb

logger = util.conf_logger('deephyper.searches.nas.nas_a3c_async')
...
class NasPPOAsyncA3C(Search):
    def __init__(self, problem, run, evaluator, **kwargs):
        ...
        self.reward_rule = util.load_attr_from('deephyper.searches.nas.agent.utils.'+kwargs['reward_rule'])
