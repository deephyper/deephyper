...
from deephyper.searches.nas.utils.common import zipsame
...
def test_runningmeanstd():
    ...
    subprocess.check_call(['mpirun', '-np', '3',
        'python','-c',
        'from  deephyper.searches.nas.utils.common.mpi_moments import _helper_runningmeanstd; _helper_runningmeanstd()'])
