...
def load_qm9_MPNN(split='random', seed=2020):
...
def load_qm9_MPNN_sparse(split='random', seed=2020):
    print("Loading qm9 Dataset")
    qm9_tasks, (train_dataset, valid_dataset, test_dataset), transformers = load_qm9(featurizer='Weave',
                                                                                     split=split,
                                                                                     move_mean=True,
...
if __name__ == '__main__':
    train_data, valid_data, test_data, qm9_tasks, transformers = load_qm9_MPNN_sparse()
