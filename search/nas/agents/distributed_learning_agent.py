...
from distributed_rewards_agent import DistributedRewardsAgent
...
class DistributedLearningAgent(DistributedRewardsAgent):
    """
    ...
    def __init__(
        ...
        super(DistributedLearningAgent, self).__init__(
            states=states,
            actions=actions,
