...
# %% 
# Error Model Greedy Selection
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Greedy Selection

from deephyper.ensemble._erm_ensemble import ERMEnsemblePredictor

ensemble = ERMEnsemblePredictor(
    predictors=predictors,
    aggregator=MixedNormalAggregator(decomposed_scale=True),
)

ensemble.fit(valid_X, valid_y)
