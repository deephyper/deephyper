...
@pytest.mark.fast
def test_serial():
    execute_evaluator("serial")


@pytest.mark.fast
def test_thread():
    execute_evaluator("thread")


@pytest.mark.fast
def test_process():
    execute_evaluator("process")
